...
describe('URL', () => {
    ...
    beforeEach(async () => {
        ...
        !URL && (URL = (await require('./index')).URL);
        !URLSearchParams && (URLSearchParams = (await require('./index')).URLSearchParams);
    });
    ...
    it('Need to polyfill / patch', () => {
        ...
        expect(window.URLSearchParams !== URLSearchParams).toBeFalse();
    });
    ...
    it('URL contains native static methods', () => {
        expect(_.isFUN(URL.createObjectURL)).toBeTrue();
