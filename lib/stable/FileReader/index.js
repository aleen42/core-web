...
module.exports = new Promise(resolve => resolve((async win => {
    ...
    // need to polyfill
    (!target.FileReader || (new Blob())._buffer != null) && polyfill();

    // need to patch for only support constructor
    (() => {
        try {
            target.FileReader();
            return 1;
    ...
    function polyfill() {
        ...
        Object.assign(FileReader.prototype, {
            ...
            readAsArrayBuffer(blob) {
                ...
                self.result = (blob._buffer.buffer || blob._buffer).slice();
            },
        });
    ...
    function patch() {
        (constructor => (target.FileReader = function FileReader() {
            if (!(this instanceof FileReader)) {
                // eslint-disable-next-line max-len
                throw new TypeError('Failed to construct \'FileReader\': Please use the \'new\' operator, this DOM object constructor cannot be called as a function.');
            }
