...
module.exports = new Promise(resolve => resolve((async win => {
    ...
    if (!win.TextDecoder || !win.TextEncoder) {
        Object.assign(target, (await import(/* webpackChunkName: "text-encoding" */'./chunk.js')).default(
            (await require('../../shim/Uint8Array')).Uint8Array,
            (await require('../../shim/ArrayBuffer')).ArrayBuffer,
        ));
    }
