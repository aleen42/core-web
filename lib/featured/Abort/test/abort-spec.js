...
describe('AbortController & AbortSignal', () => {
    ...
    it('Request object has .signal', async () => {
        ...
        expect(!request.signal).toBeFalse(); // missing request.signal
        expect(!Object.prototype.isPrototypeOf.call(Request.prototype, request)).toBeFalse(); // wrong prototype
    });
    ...
    it('instance of AbortSignal', () => {
        expect(new AbortController().signal instanceof AbortSignal).toBeTrue();
    });
});
